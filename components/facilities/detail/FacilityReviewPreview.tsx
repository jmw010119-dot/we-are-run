...
type FacilityReviewPreviewProps = { facility: FacilityDetail };

export function FacilityReviewPreview({ facility }: FacilityReviewPreviewProps) {
  return (
    <div className="h-full">
      <SectionHeader label="FACILITY REVIEW" title="시설을 이용한 러너들의 후기" description="접근성, 편의시설, 훈련 환경에 대한 실제 러너들의 짧은 리뷰입니다." compact className="mb-5" />
      ...
      <div className="mt-4"><Button variant="secondary" className="w-full sm:w-auto">전체 리뷰 보기</Button></div>
    </div>
  );
}
